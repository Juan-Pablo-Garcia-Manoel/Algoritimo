...
class Program
{
    /*Faça um programa que permita o cadastro de veículos. Aclasse veículo deverá conter os campos placa, marca,modelo e ano. Faça um menu com as seguintes opções:
Menu:
1 - Ler as informações de um veículo
2 - Verificar se uma placa está no formato correto 
(AAADDDD)
3 - Imprimir por ano
